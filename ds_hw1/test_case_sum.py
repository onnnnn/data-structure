...
def test_linked_list(k_s) -> list[float]:
    ...
    for k in k_s:   # k to use
        ...
        start_time = time()   # started time to sum items from linked list
        summation = linked_list.sum_of_node()   # traverse and sum up
...
def test_dynamic_array(k_s) -> list[float]:
    ...
    for k in k_s:
        ...
        start_time = time()
        summation = sum([i for i in dynamic_array])   # traverse and sum up
...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "average":
        ...
        plot_single(mean_time_linked_list, k_s, title="linked list", path="/img/linked_list_sum.png")
        plot_single(mean_time_dynamic_array, k_s, title="dynamic array", path="/img/dynamic_array_sum.png")
        plot_multi(mean_time_linked_list, mean_time_dynamic_array, k_s, path="/img/multi_sum.png")
        ...
        plot_single(time_linked_list, k_s, title="linked list", path="/img/linked_list_sum.png")
        plot_single(time_dynamic_array, k_s, title="dynamic array", path="/img/dynamic_array_sum.png")
        plot_multi(time_linked_list, time_dynamic_array, k_s, path="/img/multi_sum.png")